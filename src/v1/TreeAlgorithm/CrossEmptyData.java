 ...
 * @author denis
 */
public class CrossEmptyData implements BoardData {
    ...
    public CrossEmptyData(L64fbase.gob64Struct src, double komi,int metaphase) {
        mem.copy(src);
        this.komi = komi;
    ...
    public boolean equals(Object obj) {
        CrossEmptyData o=(CrossEmptyData)obj;
    ...
    public List<BoardData> getSubData() {
        ...
        long forbid=0;
        while(m!=0){
            mv.add(new CrossEmptyData(sim,komi,metaphase));
            sim.copy(mem);
            forbid|=m;
            sim.rand=rand;
    ...
    public double scoreOnce() {
        ...
        sim.copy(mem);
        sim.rand=rand;        
        double sc = sim.finishEmptyCross(komi,metaphase);
        rand=sim.rand;
